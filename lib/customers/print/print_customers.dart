...
// Future<dynamic> printCustomersRoll(MainController mainController,
//     InventoryController inventoryController) async {
//   var materialsMaps = await InventoryDatabase.getAllMaterials(
//       inventoryController
...
//   var materialsCount = await InventoryDatabase.getMaterialsCount(
